...
-- Si es null, el radar usa `Product.name` — para cuando el nombre es
-- demasiado genérico ("Pan") para una búsqueda de mercado específica.
ALTER TABLE "Product" ADD COLUMN     "radarQuery" TEXT;
...
-- Mismo patrón que 20260908004818_recipe_output_quantity.
