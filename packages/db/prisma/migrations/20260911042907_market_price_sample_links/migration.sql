-- Un producto encontrado por fuente (el más cercano a la mediana), para que el
-- radar pueda linkear "ver en Plaza Vea" al ítem real que se raspó.
-- [{ source, title, price, url }]. Null en filas de antes de este campo.
ALTER TABLE "MarketPrice" ADD COLUMN     "sampleLinks" JSONB;
...
-- Mismo patrón que 20260908004818_recipe_output_quantity / 20260911034631.
