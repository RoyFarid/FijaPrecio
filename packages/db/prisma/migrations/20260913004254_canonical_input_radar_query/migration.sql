-- Término de búsqueda curado para el scraping de insumos (scope=INPUT), igual
-- que Product.radarQuery para el radar de producto final. Null => se usa `name`.
ALTER TABLE "CanonicalInput" ADD COLUMN     "radarQuery" TEXT;
